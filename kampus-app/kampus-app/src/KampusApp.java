...
public class KampusApp {
    ...
    public void menuTambah() {
        ...
        // Periksa apakah ID prodi ada dalam database prodi
        if (db.getProdiById(idProdi) != null) {
            ...
            System.out.println("ID Prodi tidak ditemukan dalam database prodi.");
        }
    ...
    public void menuUbah() {
        ...
        if (db.getProdiById(idProdi) != null) {
            ...
            System.out.println("Data mahasiswa telah diubah.");
        } else {
            System.out.println("ID Prodi tidak ditemukan dalam database prodi.");
        }
